...
// 줄간격 2줄(배수 2.0): Word 단락 대화상자에 '2줄'로 표시되도록 w:line=480(=240*2) + auto
...
<Relationship Id="rId15" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/footer" Target="footer3.xml"/>
    ...
    console.log("✅ docGrid linePitch=360:", docXml.includes('linePitch="360"'));
    console.log("✅ 줄간격 2줄(배수 2.0):", docXml.includes('w:line="480" w:lineRule="auto"'));
